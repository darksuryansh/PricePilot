...
user_pref("app.update.lastUpdateTime.addon-background-update-timer", 1762948143);
user_pref("app.update.lastUpdateTime.background-update-timer", 1762948143);
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1762948143);
user_pref("app.update.lastUpdateTime.region-update-timer", 1762948143);
user_pref("app.update.lastUpdateTime.services-settings-poll-changes", 1762948143);
user_pref("app.update.lastUpdateTime.xpi-signature-verification", 1762948143);
user_pref("app.update.migrated.updateDir3.A2B865C3521CB50D", true);
user_pref("app.update.mode", 0);
user_pref("app.update.service.enabled", false);
user_pref("apz.content_response_timeout", 60000);
user_pref("browser.bookmarks.restore_default_bookmarks", false);
user_pref("browser.contentblocking.category", "custom");
user_pref("browser.contextual-services.contextId", "cfab2091-dc70-4c80-9008-883ec0860779");
user_pref("browser.contextual-services.contextId.timestamp-in-seconds", 1762948113);
...
user_pref("browser.newtabpage.activity-stream.impressionId", "{860b0033-4ed3-41d7-9f5c-e8b13ce78908}");
...
user_pref("browser.startup.lastColdStartupCheck", 1762948352);
...
user_pref("captchadetection.lastSubmission", 1762948);
user_pref("captivedetect.canonicalURL", "");
user_pref("datareporting.dau.cachedUsageProfileGroupID", "03a7b4a4-761d-42ee-9238-f14edf39d45c");
user_pref("datareporting.dau.cachedUsageProfileID", "64382f62-76dc-4abc-8a67-3c59cf9b6715");
...
user_pref("extensions.webextensions.uuids", "{\"formautofill@mozilla.org\":\"feb41648-8274-4964-8100-2a84749cb191\",\"newtab@mozilla.org\":\"e3631d84-01e3-4433-a46f-d036d13f122b\",\"pictureinpicture@mozilla.org\":\"95cb6937-73c7-4285-ac9b-6a9456c4e680\",\"addons-search-detection@mozilla.com\":\"80685165-6d72-4d3d-8d8b-7c65d1000070\",\"webcompat@mozilla.org\":\"9a310967-e580-48bf-b3e8-4eafebbc122d\",\"default-theme@mozilla.org\":\"beb69d8d-62e8-4f4c-97f3-6a8c7154b9fa\"}");
...
user_pref("nimbus.profileId", "f51b2c9e-1e17-4dc8-ad0b-e46d8c58a691");
...
user_pref("sanity-test.device-id", "0x468b");
...
user_pref("toolkit.profiles.storeID", "cb4517bb");
user_pref("toolkit.shutdown.fastShutdownStage", 3);
user_pref("toolkit.startup.last_success", 1762948351);
